...
const roles = [
	{
		...
		highlights: [
			...
			'Designed and built data-heavy systems for about 25,000 smart meters sending ~48 data packets each per day (≈1.2M daily) — Airflow orchestration, S3 storage, ClickHouse and Athena for analytics, PostgreSQL and Supabase, and APIs on top.',
